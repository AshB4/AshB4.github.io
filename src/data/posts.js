export const posts = [
  {
    title: "Testing RSS Import from AshB4",
    slug: "testing-rss-import-from-ashb4",
    date: "2026-06-12",
    excerpt:
  ...
  {
    title: "I Built a React Playground to Nail My Interviews — Here's What It Covers",
    slug: "react-playground-interview-prep",
    date: "2025-06-04",
    excerpt:
    ...
    includeInFeed: false,
    content:
      "<p>A practical breakdown of the React concepts I practiced while preparing for interviews, and what I would add next.</p>",
  },
  {
    title: "The Ritual Scheduler",
    slug: "the-ritual-scheduler",
    date: "2025-05-05",
    excerpt:
    ...
    devUrl: "https://dev.to/ashb4/the-ritual-scheduler-520a",
    includeInFeed: false,
    content:
      "<p>A build note about turning consistency, scheduling, and tiny rituals into a system that actually works.</p>",
  },
  {
    title:
      "I Was Drowning in Product Chaos — So I Wrote 25 Prompts and Set Fire to My Roadmap",
    slug: "product-chaos-25-prompts-roadmap",
    date: "2025-05-17",
    excerpt:
      "How I used structured prompts to cut through product chaos, rethink my roadmap, and turn scattered ideas into clearer next steps.",
    tags: [
      "product-thinking",
      "ai",
      "prompting",
    ...
    includeInFeed: false,
    content:
      "<p>How I used structured prompts to cut through product chaos, rethink my roadmap, and turn scattered ideas into clearer next steps.</p>",
  },
];
